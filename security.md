...
1. SOAP (Simple Object Access Protocol): An XML-based protocol for accessing web services over HTTP. It is platform independent and language independent.
...
2. Message level security, such as WS-Security, SAML, XML Digital Signatures, and XML Encrypttion,  can be more effective and has the added flexibility that the message can be sent over any transport.
